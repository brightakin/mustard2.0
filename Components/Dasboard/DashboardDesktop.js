...
const DashboardDesktop = () => {
  return (
    <div className="bg-[#212936] h-[90rem] w-full">
      <div className="flex gap-10">
        ...
        <div className=" w-[70rem] h-[75rem] mr-6 mt-5 bg-white rounded-3xl">
          <p className=" text-3xl w-40 h-6 font-bold mt-14 ml-7 text-[#3a3a3a]">
            Compliance
          </p>
          <div className="h-[68rem] w-[49rem] mt-20 mx-auto">
            <h1 className=" h-36 w-[36rem] mt-2 text-[30px] font-extrabold text-[#3a3a3a] leading-[40px] text-left ">
            ...
            <div className="mt-7">
              ...
              <input
                className="w-[717px] h-[115px] text-[16px] bg-[#f8f7fa] pl-3 font-normal leading-[24px] text-left  rounded-[15px] "
                type={"text"}
                id="description"
                name="description"
                placeholder="Select Industry"
            ...
            <button className="h-[70px] w-[717px] mt-8 rounded-[10px] text-[24px] bg-[#000000] text-[#ffffff] hover:scale-105 duration-500 ">
              Finish
            </button>
          </div>
        </div>
