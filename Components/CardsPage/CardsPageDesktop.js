  ...
  return (
    <div className="bg-[#212936] flex gap-10 h-[63rem] w-full">
      ...
      <div className="w-[45rem] lg:w-[56rem] xl:w-[65rem] h-[58rem] mr-6 mt-5 bg-white rounded-3xl">
        ...
        <div className="flex gap-[5rem] lg:gap-[10rem] xl:gap-[20rem]">
          <div className="flex">
            <input
          ...
          <div className="flex">
            <button className="bg-[#cbcbd4] ml-6 mt-9 w-20 lg:w-24 h-9 rounded-xl text-[#3a3a3a] text-sm lg:text-lg font-medium">
              Export
            </button>
            <button
        ...
        <div className="flex ml-4 gap-[10rem] lg:gap-[15rem] xl:gap-[16rem] mt-8">
