...
const BusinessInfo = (props) => {
  ...
  return (
    <div className=" w-[70rem] h-[60rem] mr-6 mt-5 bg-white rounded-3xl">
      ...
      <div className="flex gap-[8rem]">
        ...
        <div className="h-[40rem] w-[29rem] mt-10">
          ...
          <div className="mt-7">
            ...
            <input
              className="w-[100%] h-[6rem] text-[16px] bg-[#f8f7fa] pl-3 font-normal leading-[24px] text-left  rounded-[15px] "
              type={"text"}
              id="description"
              name="description"
              placeholder="Select Industry"
