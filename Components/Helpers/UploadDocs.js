...
const UploadDocs = (props) => {
  ...
  return (
    <div className=" w-[39.5rem] lg:w-[46rem] xl:w-[63rem] h-[43rem] mr-6 mt-5 bg-white rounded-3xl">
      ...
      <div className="flex gap-[4rem]">
        ...
        <div>
          ...
          <div className="h-[20rem] w-[19rem] lg:w-[24rem] xl:w-[36.5rem] mr-[2rem] border-2 border-[#a6a6aa] p-9 rounded-3xl mt-[-3rem]">
            <div className="flex gap-5">
              <label className="text-[#3a3a3a] text-sm lg:text-lg xl:text-2xl font-bold w-full">
                Certificate Of Incorporation
              </label>
              <button
                className="bg-[#cbcbd4] w-16 lg:w-28 h-8 rounded-lg text-xs lg:text-sm font-semibold text-[#3a3a3a]"
          ...
          <button
            ...
            className="h-[3.5rem] w-[52%] lg:w-[70%] xl:w-[95%] mr-[5rem] mt-8 rounded-[10px] text-[24px] bg-[#000000] text-[#ffffff] hover:scale-105 duration-500 "
          >
            Finish
          </button>
        </div>
